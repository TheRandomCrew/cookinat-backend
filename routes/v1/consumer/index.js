...
const getDataSlug = require('./getDataSlug'); //Gets data

/** @module routes/v1/consumer/index */

/** 
 * @description Sets all routes to consult data, all this is available through
 *              the URL: .../api/v1/consumer/...
 */
